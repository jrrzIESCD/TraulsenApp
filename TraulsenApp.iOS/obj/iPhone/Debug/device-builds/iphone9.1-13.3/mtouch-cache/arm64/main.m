...
extern void *mono_aot_module_TraulsenApp_iOS_info;
...
extern void *mono_aot_module_TraulsenApp_info;
extern void *mono_aot_module_Xamarin_Forms_Xaml_info;
extern void *mono_aot_module_XBeeLibrary_Core_info;
extern void *mono_aot_module_Common_Logging_Core_info;
extern void *mono_aot_module_SRP_info;
extern void *mono_aot_module_Common_Logging_info;
extern void *mono_aot_module_XBeeLibrary_Xamarin_info;
extern void *mono_aot_module_Plugin_BLE_Abstractions_info;
extern void *mono_aot_module_Plugin_BLE_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_TraulsenApp_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_TraulsenApp_info);
	mono_aot_register_module (mono_aot_module_Xamarin_Forms_Xaml_info);
	mono_aot_register_module (mono_aot_module_XBeeLibrary_Core_info);
	mono_aot_register_module (mono_aot_module_Common_Logging_Core_info);
	mono_aot_register_module (mono_aot_module_SRP_info);
	mono_aot_register_module (mono_aot_module_Common_Logging_info);
	mono_aot_register_module (mono_aot_module_XBeeLibrary_Xamarin_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "TraulsenApp.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
